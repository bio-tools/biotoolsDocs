...
If you would like to propose a project, then please discuss your ideas first by mailiing `Jon Ison <mailto:jison@cbs.dtu.dk>_` cc `Peter Løngreen <peterl@cbs.dtu.dk>`_.  If following this discussion, we all agree there is basis for a project, then we'd require a 1-page project proposal, the text of which we can work on together and in collaboration with other memebers of the `registry-core <>_` group.  Funding will be prioritised for proposals having the biggest potential impact on bio.tools content and quality. 
...
- each proposal requires (at least) two named mentors:  
  ...
  - someone (normally from the the `registry-core <>_` group) who will assist with supervision and oversee the delivery of the work
...
- when writing a proposal, please read the existing `proposals <>`_ below and follow the general structure and style
